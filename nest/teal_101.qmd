...
[Who is involved in the process?](https://insightsengineering.github.io/teal/latest-tag/articles/blueprint/actors.html)

Teal app developers: use available building blocks, e.g. `teal.modules.general`, `teal.modules.clinical`

Teal module developers: create new modules within the framework.
